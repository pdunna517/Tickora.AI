...
def downgrade() -> None:
    ...
    op.add_column('standup_sessions', sa.Column('closes_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True))
    ...
    op.add_column('standup_responses', sa.Column('content', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True))
